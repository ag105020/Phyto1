...
class Dmax_appro:
    def __init__(self,Dmax,ChltoCplot,NtoCplot,PtoCplot,BiomassC):
        self.Dmax=Dmax
...
def dmax_appro(Lightintensity,What_is_limiting,m,Pmax,OT,Ynphoto_chl,Cnbiosynth,Nconst_protein,Cnrna_variable,\
    ...
    O=CNprotein*A  #chl part removed based on Kei 206-4
    P=CNprotein*B+Cessential-Qc   #chl part removed based on Kei 206-4
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    X1=Dmax_appro(Dmax,ChltoCplot,NtoCplot,PtoCplot,BiomassC)
