...
if What_is_limiting==0:
    ...
    #for N limiting data
    from Sakshaug89_data_00 import data
...
def kkI(data):   #this t00function calculate for the same irradiance
    ...
    Nconst_protein=2.41170074501312E-15
...
#Print free parameters #Here units adjusted for paper
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    if Plot_NC==1:
        ...
        legend(loc='upper right', borderaxespad=0.3, fontsize=10, ncol=1)
    #    
        savefig("C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Sakshaug89\\N to C.png",dpi = DPI)
    ...
    if Plot_Chl==1:
     ...
     #   legend(loc='upper right', borderaxespad=0.6, fontsize=12)#, ncol=2)
         
        savefig("C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Sakshaug89\\Chl to C.png",dpi = DPI)
    ...
    #        stackplot(Dd,Nconst_other_plot,Nconst_protein_plot,Nproteinsynth_plot,Nphoto_plot,Ndna_plot,Nrna_plot,Nchl_plot,colors=StackPlotColorsN)
        ...
        #     yticks(arange(0,26,5))
            ...
            xlim([lowlim,highlim])
            ylim([0,0.300001])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Sakshaug89\\N-C broad\\Fig."
        ...
        #     yticks(arange(0,26,5))
            xticks(XTICKS)
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Sakshaug89\\C allocation broad\\Fig."
        ...
        #     yticks(arange(0,26,5))
            ...
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Sakshaug89\\Fig."
