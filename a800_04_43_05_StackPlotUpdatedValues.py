...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    if Plot_PC==1:    
        figure(5)
        plot(Dd,PtoCplot, color=plotcolor,label=str(I)+'\\textrm{\\greektext m}E m$^{-2}$s$^{-1}$')
        plot(healey85data.D_PtoC, healey85data.PtoC,'o' ,color=plotcolor)
        
            
        xlabel('$\mu$ (d$^{-1}$)')
        ylabel('\\textrm{\\greektext m}g P mg C$^{-1}$')
        #title('P-C ratio')
    #     ylim(ymin=0)
    ...
    if Plot_NC==1:
        ...
        xlabel('$\mu$ (d$^{-1}$)')
        ylabel('\\textrm{\\greektext m}g N mg C$^{-1}$')
        ylim(ymin=0)
        if What_is_limiting==0:
            ylim(ymax=300)  
        elif What_is_limiting==1:
    ...
    #        stackplot(Dd,Nconst_other_plot,Nconst_protein_plot,Nproteinsynth_plot,Nphoto_plot,Ndna_plot,Nrna_plot,Nchl_plot,colors=StackPlotColorsN)
            ...
            ylabel('mol N mol C$^{-1}$', fontsize=30)  #copied from 73
        #     ylim([0,25])
        #     yticks(arange(0,26,5))
            xticks(arange(lowlim,highlim+step,step))
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Healey85\\N-C broad\\Fig."
        ...
        if Plot_PC_stack==1:
            ...
            xlabel('$\mu$ (d$^{-1}$)', fontsize=30)                       #copied from 73
            ylabel('mol P mol C$^{-1}$', fontsize=30)  #copied from 73
        #     ylim([0,25])
        #     yticks(arange(0,26,5))
            xticks(arange(lowlim,highlim+step,step))
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Healey85\\P-C broad\\Fig."
        ...
        #     yticks(arange(0,26,5))
            xticks(arange(lowlim,highlim+step,step))
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\C allocation\\Fig."
