...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    if healey85data.i>-1:
        if Plot_NC_stack==1:
            ...
            stackplot(Dd*ft,Nconst_protein_plot+Ndna_const_plot+Ndna_variable_plot+Nrna_const_plot,Nphoto_plot+Nchl_plot,Nbiosynth_plot+Nrna_variable_plot,Nstore_plot,colors=StackPlotColorsN)
    #        stackplot(Dd,Nconst_other_plot,Nconst_protein_plot,Nproteinsynth_plot,Nphoto_plot,Ndna_plot,Nrna_plot,Nchl_plot,colors=StackPlotColorsN)
        ...
        #     yticks(arange(0,26,5))
            ...
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\NoStorage\\ft="+str(ft)+"\\Fig."
        ...
        if Plot_PC_stack==1:
            ...
            stackplot(Dd*ft,Pconst_other_plot+Pdna_const_plot+Pdna_variable_plot,Pthylakoid_plot,Prna_variable_plot+Prna_const_plot,Pstore_plot,colors=StackPlotColorsP,edgecolor='none')
