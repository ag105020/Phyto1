...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    if Plot_NC==1:
        figure(6)
        plot(Dd, NtoCplot, color=plotcolor,label=str(int(round(I,0)))+' \\textrm{\\greektext m}mol m$^{-2}$ s$^{-1}$')
        ...
        xlim(xmax=Xmax)
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Chalup90\\N to C.png",dpi = DPI)
     
    #     ylim([0,21])
    #     yticks(arange(0,21,5))
    if Plot_Chl==1:
        figure(7)
        plot(Dd,ChltoCplot,color=plotcolor,label=str(int(I))+' \\textrm{\\greektext m}E m$^{-2}$ s$^{-1}$')
   ...
   #     legend(loc='upper right', borderaxespad=0.6, fontsize=20, ncol=1)
        ...
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Chalup90\\Chl to C.png",dpi = DPI)
    ...
    if data.i>-1:
        if Plot_NC_stack==1:
            ...
            stackplot(Dd,Nconst_protein_plot+Ndna_const_plot+Ndna_variable_plot+Nrna_const_plot,Nphoto_plot+Nchl_plot,Nbiosynth_plot+Nrna_variable_plot,Nstore_plot,colors=StackPlotColorsN)
    #        stackplot(Dd,Nconst_other_plot,Nconst_protein_plot,Nproteinsynth_plot,Nphoto_plot,Ndna_plot,Nrna_plot,Nchl_plot,colors=StackPlotColorsN)
            ...
            ylabel('N:C (mol/mol)', fontsize=30)  #copied from 73
        #     ylim([0,25])
        #     yticks(arange(0,26,5))
            xticks(XTICKS)
            xlim([lowlim,highlim])
            ylim([0,0.3000001])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Chalup90\\N-C broad\\Fig."
        ...
        #     yticks(arange(0,26,5))
            xticks(XTICKS)
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Chalup90\\C allocation broad\\Fig."
            Figure_number=str(FigurenumberC+data.i)
            Last_part=".png"
            ylim(ymax=percentorratio+1e-20)
            xlim(xmax=Xmax)
            title('Light: '+str(int(round(I,0)))+' \\textrm{\\greektext m}mol m$^{-2}$ s$^{-1}$',y=1.02)
            savefig(First_part+Figure_number+Last_part,dpi = DPI) 
        ...
        #     yticks(arange(0,26,5))
            ...
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keisuke\\Desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\C allocation smalls\\Fig."
