...
class Dmax_comp:
    def __init__(self,Dmax,ChltoCplot,NtoCplot,NtoPplot,PtoCplot,BiomassC,Prna,Pthylakoid,Pdna,Pstore,Limitation):
        self.Dmax=Dmax
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    X1=Dmax_comp(Dmax,ChltoCplot,NtoCplot,NtoPplot,PtoCplot,BiomassC,Prna,Pthylakoid,Pdna,Pstore,Limitation)
