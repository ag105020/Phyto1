...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    #    legend(loc='upper right', borderaxespad=0.6, fontsize=20)#, fancybox=True)
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\C concentration.png",dpi=DPI)
     
    if Plot_PC==1:    
        figure(5)
        plot(Dd,PtoCplot, color=plotcolor,label=str(I)+'$\mu$E m$^{-2}$s$^{-1}$')
        plot(healey85data.D_PtoC, healey85data.PtoC,'o' ,color=plotcolor)
        
            
        xlabel('$\mu$ (d$^{-1}$)')
        ylabel('$\mu$g P mg C$^{-1}$')
        #title('P-C ratio')
    #     ylim(ymin=0)
    #    legend(loc='upper left', borderaxespad=0.6, fontsize=18, ncol=2)
        ...
        if What_is_limiting==0:
            ...
            ylim(ymax=35)
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\P to C.png",dpi=DPI)
 
    if Plot_NC==1:
        figure(6)
        plot(Dd, NtoCplot, color=plotcolor,label=str(I)+'$\mu$E m$^{-2}$s$^{-1}$')
        plot(healey85data.D_NtoC, healey85data.NtoC,'o' ,color=plotcolor)
        xlabel('$\mu$ (d$^{-1}$)')
        ylabel('$\mu$g N mg C$^{-1}$')
        ylim(ymin=0)
        if What_is_limiting==0:
            ylim(ymax=300)  
        elif What_is_limiting==1:
     ...
     #   legend(loc='lower right', borderaxespad=0.6, fontsize=14, ncol=2)
        xlim(xmax=Xmax)
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\N to C.png",dpi=DPI)
    ...
    if Plot_Chl==1:
        ...
        xlabel('$D$ (d$^{-1}$)')
        ylabel('$\mu$g chlorophyll a mg C$^{-1}$')
     ...
     #   legend(loc='upper right', borderaxespad=0.6, fontsize=12)#, ncol=2)
        ...
        savefig("C:\\Users\\Keisuke\\desktop\\figures\\Phytoplankton model\\"+Whatislimiting+"\\Chl to C.png",dpi=DPI)
    ...
    if healey85data.i>-1:
        if Plot_NC_stack==1:
            ...
            stackplot(Dd,Nconst_protein_plot+Ndna_const_plot+Ndna_variable_plot,Nphoto_plot+Nchl_plot,Nbiosynth_plot+Nrna_variable_plot+Nrna_const_plot,Nstore_plot,colors=StackPlotColorsN)
    #        stackplot(Dd,Nconst_other_plot,Nconst_protein_plot,Nproteinsynth_plot,Nphoto_plot,Ndna_plot,Nrna_plot,Nchl_plot,colors=StackPlotColorsN)
        ...
        #     yticks(arange(0,26,5))
            ...
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Healey85\\N-C broad\\Fig."
        ...
        if Plot_PC_stack==1:
            ...
            stackplot(Dd,Pconst_other_plot+Pdna_const_plot+Pdna_variable_plot,Pthylakoid_plot,Prna_variable_plot+Prna_const_plot,Pstore_plot,colors=StackPlotColorsP,edgecolor='none')
        ...
        #     yticks(arange(0,26,5))
            xticks(arange(lowlim,highlim+step,step))
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\Healey85\\P-C broad\\Fig."
        ...
        FigurenumberC=20
        if Plot_C_stack==1:
            figure(FigurenumberC+healey85data.i)
            stackplot(Dd,Cessential_plot,Cnstore_plot,Cconst_protein_plot,Cphoto_plot,Cbiosynth_plot,Cdna_const_plot+Cdna_variable_plot,\
                      Crna_const_plot+Crna_variable_plot,Cchl_plot,CthylakoidPG_plot,Cother_plot,colors=StackPlotColorsC)
        ...
        #     yticks(arange(0,26,5))
            xticks(arange(lowlim,highlim+step,step))
            xlim([lowlim,highlim])
            First_part="C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Phytoplankton model\\"+Whatislimiting+"\\C allocation\\Fig."
        ...
        if Plot_C_stack_small==1:
            figure(FigurenumberCsmalls+healey85data.i)
        ...
        #     yticks(arange(0,26,5))
            ...
            Figure_number=str(FigurenumberCsmalls+healey85data.i)
            Last_part=".png"
            ylim(ymax=10)
            savefig(First_part+Figure_number+Last_part,dpi=DPI) 
        ...
        figure(200)
        plot(Dd,(Crna_const_plot+Crna_variable_plot)/(Cphoto_plot+Cbiosynth_plot+Cconst_protein_plot),color=plotcolor)
        ylabel('mol C mol C$^{-1}$')
