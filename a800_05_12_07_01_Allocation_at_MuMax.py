...
figure(11)
plot(Dmax*86400,rCphoto*100,'orange',label='Photo')
plot(Dmax*86460,(rCbiosynth+rCconst_protein)*100,'green',label='Bio + Other')
ylim(ymin=0)
xlabel('$\mu_{max}$ (d$^{-1}$)')
ylabel('Protein allocation ($\%$)')
title('Model: S. linearis',y=1.02)
legend(loc = 4,fontsize=20)
savefig("C:\\Users\\Keiin\\OneDrive\\desktop\\figures\\01\\Phytoplankton model\\Jahn2018\\Model.png",dpi=DPI)
